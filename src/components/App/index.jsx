...
import {Wrapper,Navigation,Calories,ActiveControllerWrapper,NavigationString,MenuList,ResultHeading,ControllerWrapper,ListItem,Range,List,SearchBlock,Menu,SearchButton,SearchInput,Heading,GlobalStyle,MenuSummary} from './styles';
     ...
     return (
          <Wrapper>
               ...
               <Heading>Food searching engine</Heading>
                    <Menu onSubmit={getSearch}>
                         ...
                         <Calories>
                              ...
                              <p>{caloriesNum < 200 ? `Note: if calories level is too low the system will show you dishes with most possible low calories level, but not certain number.` : ``}</p>
                         </Calories>
                         ...
                         <MenuList>
                              ...
                              <ul>
                                   ...
                                   <ListItem><label><input onChange={updateHealth} value='immuno-supportive' type="radio" name="health"></input>immuno-supportive</label></ListItem>
                                   ...
                                   <ListItem><label><input onChange={updateHealth} value='pork-free' type="radio" name="health"></input></label>pork-free</ListItem>
                              </ul>
                         </MenuList>
                         <div>
               ...
               <Navigation onClick={showMenu}>
                    ...
                    : <h1>There's no results for such request.</h1>     
               }</List>
          </Wrapper>
     )
} 
